              ...
              <div class="card-body">
                ...
                >
                  <div class="d-flex align-items-start flex-column h-100">
                    <h3
                      class="text-dark fw-semibold fs-20 lh-base mx-auto mb-3"
                    >
                  ...
                  <div class="">
                    <img
                      src="/assets/images/widget/girls.png"
                      alt=""
                      class="mb-n3 float-end"
                    />
                  </div>
                </div>
              </div>
                ...
                <div class="d-flex mb-2">
                  <div class="rounded-2 bg-white p-1 shadow-sm border">
                    ...
                    >
                      <path
                        fill="#c26316"
                        d="M6.444 3.685a10 10 0 0 1 1.662-.896c1.403-.593 2.104-.89 3-.296C12 3.086 12 4.057 12 6v2c0 1.886 0 2.828.586 3.414S14.114 12 16 12h2c1.942 0 2.914 0 3.507.895s.297 1.596-.296 3a10 10 0 0 1-11.162 5.913A10 10 0 0 1 6.444 3.685"
                      />
                      <path
                        fill="#060707"
                        fill-rule="evenodd"
                        d="M13.774 2.128a.75.75 0 0 1 .913-.54a10.77 10.77 0 0 1 7.725 7.725a.75.75 0 0 1-1.453.374a9.27 9.27 0 0 0-6.646-6.646a.75.75 0 0 1-.54-.913"
                        clip-rule="evenodd"
                        opacity="0.5"
                      />
                    </svg>
          ...
          <div class="col-md-6 col-xl-6">
            <div class="card">
              <div class="card-body">
                  ...
                  <div class="rounded-2 bg-white p-1 shadow-sm border">
                    ...
                    >
                      <path
                        fill="#287F71"
                        fill-rule="evenodd"
                        d="M12 22c4.836 0 8.757-3.884 8.757-8.675c0-4.79-3.92-8.674-8.757-8.674s-8.757 3.883-8.757 8.674S7.163 22 12 22m0-13.253c.403 0 .73.324.73.723v3.556l2.218 2.198a.72.72 0 0 1 0 1.022a.735.735 0 0 1-1.032 0l-2.432-2.41a.72.72 0 0 1-.214-.51V9.47c0-.4.327-.723.73-.723M8.24 2.34a.72.72 0 0 1-.232.996l-3.891 2.41a.734.734 0 0 1-1.006-.23a.72.72 0 0 1 .232-.996l3.892-2.41a.734.734 0 0 1 1.006.23m7.519 0a.734.734 0 0 1 1.005-.23l3.892 2.41a.72.72 0 0 1 .232.996a.734.734 0 0 1-1.006.23l-3.891-2.41a.72.72 0 0 1-.233-.996"
                        clip-rule="evenodd"
                      />
                    </svg>
                  </div>
                ...
                <div class="d-flex align-items-baseline mb-2">
                  <div class="fs-22 mb-0 me-2 fw-semibold text-dark">
                    90 Sec
                  </div>
                  <div class="me-auto">
                    <span class="text-primary d-inline-flex align-items-center">
                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <span
                          class="avatar rounded-circle avatar-sm bg-light d-flex align-items-center justify-content-center"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="20"
                    ...
                    <td>
                      <span class="fs-14"
                        ><i
                          class="mdi mdi-arrow-up me-1 text-success align-middle fs-16"
                        ></i
                        >45,379</span
                      >
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="fs-14"
                        ><i
                          class="mdi mdi-arrow-down me-1 text-danger align-middle fs-16"
                        ></i
                        >12,457</span
                      >
                    </td>
                      ...
                      <div class="d-flex align-items-center gap-2">
                        ...
                        >
                          ...
                          >
                            <path
                              fill="#963b68"
                              d="M11.996 2c-5.462 0-9.278 3.958-9.278 9.899C2.718 17.189 6.43 22 12.004 22c5.567 0 9.278-4.819 9.278-10.101c0-5.94-3.824-9.899-9.286-9.899m0 18.384c-3.397 0-3.77-5.013-3.77-8.71V11.6c0-3.996.598-8.23 3.748-8.23s3.786 4.361 3.786 8.357c0 3.696-.367 8.657-3.764 8.657"
                            />
                          </svg>
                        </span>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              <path
                                d="M29.384 38.58s5.985-1.098 5.985 3.92H16.524c-6.184 0-11.197-5.013-11.197-11.197c0-2.9 1.1-5.548 2.914-7.533c3.51-3.84 5.1-5.194 5.1-8.375s-3.953-5.124-8.014-2.65C8.806 6.678 11.574 5.5 17.228 5.5s8.305 4.712 8.305 8.835c0 8.187-13.197 8.894-13.197 20.917"
                              />
                              <path
                                d="M29.384 38.58a9.131 9.131 0 0 0-15.58-9.521"
                              />
                              <path
                                d="M18.141 25.52c5.272-3.705 12.575-2.233 17.228 2.185c5.36-.943 7.304 2.356 7.304 2.356c-2.28-.178-5.034.656-6.854 1.343a3.04 3.04 0 0 1-3.336-.79c-3.593-3.961-9.133-7.585-14.342-5.093"
                              />
                              <path
                                d="M22.98 23.573s2.789-2.863 8.973-6.175c-.236-3.004-.088-4.13 1.414-5.066c2.65.67 3.18 3.829 3.18 3.829c4.889 1.649 6.832 8.304 5.007 9.247s-7.741.256-11.353-.98"
                              />
                            </g>
                            <path
                              fill="none"
                              ...
                              stroke-linecap="round"
                              stroke-linejoin="round"
                              d="M19.44 31.252V38.1c0 .635.516 1.15 1.152 1.15h.345m-2.705-6.099h2.417"
                            />
                          </svg>
                        </span>
          ...
          <div class="card-body">
            <ul class="p-0 m-0">
              <li class="d-flex align-items-center mb-3">
                <div
                  class="avatar avatar-sm flex-shrink-0 me-3 d-flex align-items-center justify-content-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="30"
                ...
                >
                  <div class="me-2">
                    <div class="d-flex align-items-center">
                      <h6 class="mb-0 me-1 fs-14 fw-semibold text-dark">
                        8,567
                      </h6>
                    </div>
                  ...
                  <div class="user-progress">
                    <p
                      class="text-primary mb-0 d-flex align-items-center gap-1"
                    >
                      <i
                        class="mdi mdi-arrow-up text-success align-middle fs-16"
                      ></i>
                      40.8%
                    </p>
                  </div>
                ...
                >
                  ...
                  <div class="user-progress">
                    <p class="text-danger mb-0 d-flex align-items-center gap-1">
                      <i
                        class="mdi mdi-arrow-down text-danger align-middle fs-16"
                      ></i>
                      35.8%
                    </p>
                  </div>
                ...
                >
                  ...
                  >
                    ...
                    <g fill="#428bc1">
                      ...
                      <path
                        d="m31.8 25l-.2 4.3l.2 2.7l.3-2.7zm-1.8.2l.9 4.3l.9 2.5l-.4-2.7z"
                      />
                      <path
                      ...
                      <path
                        d="m25.1 30.2l4.1 1.3l2.6.5l-2.5-.9zm-.3 1.8l4.4.2l2.6-.2l-2.6-.2z"
                      />
                      <path
              ...
              <li class="d-flex align-items-center mb-3">
                ...
                >
                  ...
                  >
                    ...
                    />
                    <g fill="#fff">
                      <path d="M14 8C6.7 13.5 2 22.2 2 32h12z" />
                      <path d="M8 14h24V2C22.2 2 13.5 6.7 8 14" />
                      <path
                        d="M9.8 11.8L26 32h6v-7.5L17.1 5.9c-2.7 1.6-5.2 3.6-7.3 5.9"
                      />
                    </g>
                    <g fill="#ed4c5c">
                      <path
              ...
              <li class="list-group-item px-0 pt-0">
                <div class="d-flex align-items-center gap-3">
                  ...
                  <div class="ms-auto align-content-center">
                    ...
                    <span class="badge bg-success-subtle text-success fs-12 p-1"
                      ><i
                        class="mdi mdi-arrow-up text-success align-middle fs-14"
                      ></i>
                      2.6%</span
                    >
                  </div>
              ...
              <li class="list-group-item px-0">
                <div class="d-flex align-items-center gap-3">
                  ...
                  <div class="ms-auto align-content-center">
                    ...
                    <span class="badge bg-danger-subtle text-danger fs-12 p-1"
                      ><i
                        class="mdi mdi-arrow-down text-danger align-middle fs-14"
                      ></i>
                      0.8%</span
                    >
                  </div>
                    ...
                    <div class="align-content-center text-center rounded-3">
                      ...
                      >
                        ...
                        >
                          <path
                            fill="#6c757d"
                            d="M19.992 11.643q.425-.38.789-.752c.754-.77 1.342-1.54 1.672-2.268c.324-.716.458-1.544.012-2.258c-.42-.67-1.185-.96-1.956-1.064c-.79-.107-1.75-.041-2.797.152l-.888.165a8 8 0 0 0-12.82 6.641l-.527.593c-.84.817-1.497 1.636-1.872 2.403c-.366.75-.54 1.627-.07 2.38c.433.691 1.232.979 2.032 1.074c.825.098 1.828.016 2.923-.201q.323-.064.66-.145a8 8 0 0 1-1.311-1.26c-.853.146-1.56.18-2.095.116c-.632-.075-.865-.264-.937-.38c-.063-.1-.132-.358.145-.925c.241-.494.688-1.092 1.342-1.758a8 8 0 0 0 1.545 2.947q.176-.03.36-.067c2.02-.4 4.613-1.351 7.28-2.772c2.665-1.42 4.848-3.012 6.227-4.42a8 8 0 0 0-1.545-2.947c.885-.151 1.61-.182 2.149-.11c.594.08.813.262.883.374c.06.095.126.33-.107.844c-.227.502-.683 1.129-1.377 1.836l-.003.003c.161.576.259 1.179.286 1.799"
                          />
                          <path
                            fill="#6c757d"
                            d="M12 20a8 8 0 0 0 7.992-8.357c-1.481 1.327-3.49 2.71-5.808 3.945c-2.492 1.328-4.96 2.281-7.033 2.775A7.97 7.97 0 0 0 12 20"
                          />
                        </svg>
                      </span>
                    </div>
  ...
  data() {
    return {
      options: {
        chart: {
          id: "monthly-sales",
          toolbar: { // This is the key part to hide the toolbar
            show: false,
          },
        },
        xaxis: {
