          ...
          <li class="d-none d-sm-flex">
            <button type="button" class="btn nav-link" data-toggle="fullscreen">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-maximize align-middle fullscreen noti-icon"
              >
                <path
          ...
          <li class="d-none d-sm-flex">
            <button type="button" class="btn nav-link" id="light-dark-mode">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-moon align-middle dark-mode"
              >
                <path
              ...
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-sun align-middle light-mode"
              >
                      ...
                      >
                        <div class="simplebar-content" style="padding: 0px">
                          ...
                          >
                            ...
                            <div class="notify-content">
                              ...
                              <p class="noti-mentioned p-2 rounded-2 mb-0 mt-2">
                                <span class="text-primary">@Patryk</span> Please
                          ...
                          >
                            ...
                            <p class="mb-0 user-msg">
                              <small class="fs-14"
                                >Completed<span class="text-reset"
                          ...
                          >
                            ...
                            <div class="notify-content">
                              ...
                              <p class="noti-mentioned p-2 rounded-2 mb-0 mt-2">
                                <span class="text-reset">@Patryk</span> Please
                                make sure that you're....
                              </p>
                            </div>
                          </a>
